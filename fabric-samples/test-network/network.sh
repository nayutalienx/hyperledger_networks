...
function printHelp() {
  ...
  println "    -ccp <path>  - Optional, path to the chaincode. When provided the -ccn will be used as t he deployed name and not the short name of the known chaincodes."
